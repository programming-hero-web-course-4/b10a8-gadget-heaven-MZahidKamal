            ...
            <div
                ...
                <div className="right-buttons flex gap-x-5 relative">
                    <NavLink to={'/dashboard/cart'}
                        ...
                        {cart.length > 0 && (<span className={`absolute top-0 -right-4 w-5 h-5 ${currentUrl === '/' ? 'bg-white text-purple-600' : 'bg-purple-600 text-white'} text-xs font-bold rounded-full flex justify-center items-center -translate-x-1/2 -translate-y-1/2`}>{cart.length}</span>)}
                    </NavLink>
